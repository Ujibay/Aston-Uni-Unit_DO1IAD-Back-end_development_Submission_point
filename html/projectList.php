...
$url = 'http://127.0.0.1:3000/projectList';
    ...
    <body>
        <div class="oldSchoolFramesStyle">
            ...
            <main class="mainFrame">
                <h1>Project List</h1>
                <p>This is a list of all projects on the database, for more detailed information on the project please click on the project title.</p>
                <table>
                    <thead>
                        <tr>
                            <th>Title</th>
